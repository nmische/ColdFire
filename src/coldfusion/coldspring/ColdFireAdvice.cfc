<cfcomponent name="ColdFireAdvice" 
			displayname="ColdFireAdvice" 
			extends="coldspring.aop.AfterReturningAdvice" 
			hint="Outputs ColdFusion debugging info to x-coldfire HTTP headers." 
			output="false">
