...
<html>
<head>
	<title>Railo ColdFire Variables Test</title>
</head>
<body>
<h1>Railo ColdFire Variables Test</h1>
<p>This page generates the following variables: flightNumber, stations, multilineVar, testScript.</p>
</body>
</html>
</cfoutput>
